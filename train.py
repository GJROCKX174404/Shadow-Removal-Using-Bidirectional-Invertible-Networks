...
def train_model(model, dataloaders, criterion, optimizer, scheduler, num_epochs, device, save_dir):
    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'val']:
            ...
            if (phase == 'val' and epoch_metric > best_metric) or (phase == 'train' and epoch==249) or (phase=='train' and epoch==499) or (phase=='train' and epoch==749) or (phase=='train' and epoch==999) or (phase=='train' and epoch==1199):
                if phase == 'val':
